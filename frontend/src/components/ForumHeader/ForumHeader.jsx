      ...
      <div className='d-flex'>
         ...
         <main className="container-fluid">
            <form className="mx-auto sticky-top d-flex bg-light-subtle align-items-center justify-content-center gap-5 shadow-sm">
               ...
               <div className={`${isFocused ? 'sel-bd' : ''} dropdown d-none d-lg-inline my-2 col-4 bg-body-secondary rounded-5 d-flex align-items-center ps-3`}>
                  ...
                  />
                  <ul className='dropdown-menu col-10 justify-content-center' aria-labelledby="searchHistory">
                     <li className="d-flex justify-content-between col-11 mx-auto border-bottom pb-1" >
                        <h6 className="dropdown-header">Recently</h6>
                        <button type='button' className="rounded-5 ctm-btn"
                           onClick={() => {
                              setSearchHistory([]);
                     ...
                     {searchHistory.length > 0 && searchHistory.map((query, index) => (
                        <li key={index}>
                           <Link className="dropdown-item d-flex col-11 mx-auto align-items-center" to={`/search?keyword=${query}`}>
                              <i className="fa-solid fa-magnifying-glass p-2"></i>
                              <span>{query}</span>
                              <button type='button' className="rounded-5 ctm-btn ms-auto d-flex"
                                 onClick={(e) => {
                                    e.preventDefault();
                                    e.stopPropagation();
