        ...
        <CardBody>
          <div className="card__top d-flex align-items-center justify-content-between">
            <span className="tour__location d-flex align-items-center gap-1">
              <i className="ri ri-map-pin-line" style={{ color: color.secondary }}></i> {city}, {country}
            </span>
            <span className="tour__location d-flex align-items-center gap-1">
          ...
          <div className="card__bottom d-flex align-items-center justify-content-between mt-3" style={{ color: color.secondary }}>
            <h5>
