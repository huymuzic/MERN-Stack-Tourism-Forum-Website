          ...
          <div>
            {post.status !== "deleted" &&
              (post.status === "unarchived" ? (
                <>
                  <CustomToolTip text="Archive post" position={"top"}>
                    <button
                ...
                <>
                  <CustomToolTip text="Unarchive post" position={"top"}>
                    <button
                  ...
                  <PopUpBase
                    ...
                    title="Unarchive post Confirmation"
                    desc={`Are you sure you want to unarchive this post?`}
                  />
                </>
              ))}
          </div>
