...
export const postStatuses = [
  { Id: 1, Value: "unarchived", Name: "Active", bgColor: "#C8E6C9", color: "green" },
  { Id: 2, Value: "archived", Name: "Inactive", bgColor: "#F5F5F5", color: "grey" },
  { Id: 3, Value: "deleted", Name: "Deleted", bgColor: "#DC143C", color: "red" }
];
...
export const PostStatusBox = ({ status }) => {
  ...
  return (
      <div className="px-2 py-1 rounded" style={{ backgroundColor: postStatus?.bgColor }}>
