          ...
          <Row className="align-items-center">
            <Col md={10}>
              <p className="terms-privacy__p" style={textStyle}>
                ...
                <Link to="/terms-of-service" target="_blank" style={linkStyle}>
                  Terms of Service
                </Link>{" "}
                and{" "}
                <Link to="/privacy-policy" target="_blank" style={linkStyle}>
                  Privacy Policy
                </Link>
                .
              </p>
            </Col>
            <Col md={2} className="text-right terms-privacy__btn__container">
              <Button
