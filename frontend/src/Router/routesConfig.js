export const routesConfig = [
  ...
  { path: '/forum/p/:id', component: 'CommunityForum/ForumPosts', name: 'Forum Posts' },
  { path: 'search', component: 'CommunityForum/ForumSearch', name: 'Forum Search' },
  ...
  { path: '/profile/:id', component: 'OtherUserProfile/index', name: 'User Profile' },
  { path: '/history', component: 'PurchaseHistory/index', name: 'Purchase History' },
  { path: '/tours/search', component: 'SearchResultList/index', name: 'Search Result List' },
  ...
  { path: '/terms-of-service', component: 'TermsOfService/index', name: 'Terms of Service' },
  { path: '/privacy-policy', component: 'PrivacyPolicy/index', name: 'Privacy Policy' },
];
